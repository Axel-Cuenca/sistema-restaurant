		  ...
		  <li class="active">Recetas</li>
			...
			<div class="row">
			  <div class="col-xs-12 text-right">
				  <a href='banneradd.php' class="btn btn-default" ><span class="glyphicon glyphicon-plus"></span> Agregar Receta!</a>
...
<script>
	...
	function eliminar_slide(id){
		...
		if(confirm('Esta acción eliminará de forma permanente la receta \n\n Desea continuar?')){
		$.ajax({
			url:'./ajax/banner_ajax.php',
			data: parametros,
			 beforeSend: function(objeto){
